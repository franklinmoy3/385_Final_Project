...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../fp_soc.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001290
SOPC_SYSID_FLAG += --sidp=0x8001290
ELF_PATCH_FLAG  += --sidp 0x8001290

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650386622
SOPC_SYSID_FLAG += --timestamp=1650386622
ELF_PATCH_FLAG  += --timestamp 1650386622
